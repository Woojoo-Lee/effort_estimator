...
export const DEFAULT_ITEMS = {
  ...
  stats: [
    ...
    {
      item_code: "STATS_HISTORY",
      itemCode: "STATS_HISTORY",
      name: "이력 통계 화면",
      quantity: 1,
      is_realtime: false,
      use_export: true,
    ...
    {
      item_code: "STATS_REPORT",
      itemCode: "STATS_REPORT",
      name: "리포트 개발",
      quantity: 1,
      is_realtime: false,
      use_export: true,
    ...
    {
      item_code: "STATS_BATCH",
      itemCode: "STATS_BATCH",
      name: "ETL/배치 구성",
      quantity: 1,
      is_realtime: false,
      use_export: false,
